...
交叉验证(5折，按场景狗分组)宏F1：均值=0.905 标准差=0.029

## 特征重要性(permutation importance，全量数据)

| 特征 | 重要性均值 | 标准差 |
|---|---|---|
| skin_redness_level | 0.1020 | 0.0108 |
| coat_quality_level | 0.0508 | 0.0050 |
| model_a_proba_C1 | 0.0456 | 0.0079 |
| odor_level | 0.0255 | 0.0048 |
| skin_lesion_severity | 0.0244 | 0.0026 |
| hair_loss_spot_count_level | 0.0084 | 0.0022 |
| hair_loss_max_diameter_level | 0.0049 | 0.0015 |
| duration_median | 0.0017 | 0.0007 |
| wear_completeness_ratio | 0.0005 | 0.0009 |
