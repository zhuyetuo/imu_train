...
交叉验证(5折，按场景狗分组)宏F1：均值=0.911 标准差=0.038

## 特征重要性(permutation importance，全量数据)

| 特征 | 重要性均值 | 标准差 |
|---|---|---|
| skin_redness_level | 0.0894 | 0.0116 |
| model_a_proba_C1 | 0.0665 | 0.0082 |
| coat_quality_level | 0.0504 | 0.0069 |
| odor_level | 0.0439 | 0.0039 |
| skin_lesion_severity | 0.0380 | 0.0044 |
